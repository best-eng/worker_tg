...
os.makedirs("output/tg_repost_bot", exist_ok=True)
...
# requirements.txt
requirements = '''python-telegram-bot[job-queue]==21.9
pytz
'''
...
for filename, content in files.items():
    with open(f"output/tg_repost_bot/{filename}", "w", encoding="utf-8") as f:
        f.write(content)

print("Files written:", os.listdir("output/tg_repost_bot"))
